...
<style type="text/css" media="screen">
	...
	* html body { margin-top: 28px !important; }
                    ...
                    <div class="grid_24">
                        <div class="header" id="#top">
                            ...
                            <div class="grid_12 omega">
                                <div class="contactinfo"><form class="searchform" action="searchpost.php" method="post">
    ...
    <div>
		...
		<h1>Sökresultat för kommentarer</h1>
<?php
mysql_connect ("localhost", "root","")  or die (mysql_error());
mysql_select_db ("ny");
 
$sokpost = $_POST['sokpost'];
 
$sql = mysql_query("select * from posts where post_content like '%$sokpost%'");
...
while ($row = mysql_fetch_array($sql)){
     $test=substr($row['post_content'],0,20).'...';
   echo '<a href="topic.php?id=' . $row['post_topic'] . '">'.$test.'</a>';
